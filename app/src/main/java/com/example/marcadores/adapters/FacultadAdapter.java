...
public class FacultadAdapter implements GoogleMap.InfoWindowAdapter {
    ...
    private void renderWindowData(Marker marker, View view){
        ...
        ImageView logoImage = (ImageView) view.findViewById(R.id.logoUTEQ);
        TextView facultadName = (TextView) view.findViewById(R.id.facultad);
        TextView decanoName = (TextView) view.findViewById(R.id.decano);
        TextView direccionName = (TextView) view.findViewById(R.id.direccion);
        TextView telefonoNum = (TextView) view.findViewById(R.id.telefono);
